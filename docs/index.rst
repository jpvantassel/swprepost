.. swprepost documentation master file, created by sphinx-quickstart on
...
released in the near future. To be notified of future releases, you can either
``watch`` the repository on
`Github <https://github.com/jpvantassel/swprepost>`_ or
``Subscribe to releases`` on the
`Python Package Index (PyPI) <https://pypi.org/project/swprepost/>`_.
